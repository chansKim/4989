...
<div class="dashboard">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation"><a class="main_menu" href="#complete" aria-controls="complete" role="tab" data-toggle="tab">거래완료</a></li>
    <li role="presentation"><a class="main_menu" href="#buy" aria-controls="buy" role="tab" data-toggle="tab">구매</a></li>
    <li role="presentation"><a class="main_menu" href="#sell" aria-controls="sell" role="tab" data-toggle="tab">판매</a></li>
    <li role="presentation"><a class="main_menu" href="#all" aria-controls="all" role="tab" data-toggle="tab">전체</a></li>
  </ul>
	...
	<table class="dashboard_table"   width="100%" align="center">
		...
		<c:choose>
		<c:when test="${fn:length(get_myscrap) eq 0}" >
	...
	<tr>
	<td>
	<c:forEach var="key" items="${get_myscrap}" varStatus="loop">
      ...
      <hr>
         ...
         <p>
            <div align="right"  align="justify" style="PADDING-RIGHT: 20px;">
			 ...
			 &nbsp;&nbsp;
	 		  <span class="glyphicon glyphicon-trash" onclick="deletePost('${key.r_name}','${key.r_id}')"></span></a>
			 &nbsp;&nbsp;
