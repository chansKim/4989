...
<!-- <a href="#" class="btn btn-default" data-toggle="modal">삭제</a>
 --><br><br>
...
<ul class="nav nav-tabs nav-justified">
 <li role="presentation" class="active">
  ...
  <li>
    <a class="dropdown-toggle" href="./mySendMessage.do" role="button" aria-expanded="true">
...
<td bgcolor="white">
 <table id="checkboxTestTbl" color="#ECEBEB">
        <caption>  </caption>
        <colgroup>
            <col width="5%"/>
            <col width="20%"/>
        ...
        <c:forEach var="key" items="${get_myMessage}" varStatus="loop">
        <tr>
