...
<div class="dashboard" >
  ...
  <li role="presentation" style="padding-top:10px;"> 
    ...
    <li role="presentation"><a class="main_menu" href="./home_list.do?param=complete">거래완료</a></li>
    <li role="presentation"><a class="main_menu" href="./home_list.do?param=buy">구매</a></li>
    <li role="presentation"><a class="main_menu" href="./home_list.do?param=sell">판매</a></li>
    <li role="presentation"><a class="main_menu" href="./home_list.do?param=all">전체</a></li>
	...
	<tbody>
	<!-- <tr>
	<th>ID</th><th>물품상태</th><th>제목</th><th>기능</th>
	</tr> -->
	...
	<td bgcolor="white" width="12%">
		...
		</c:when>			<c:when test="${key.post_type == 3}">
		<font color="blue"><center>거래완료</center></font>
		</c:when>
		</c:choose>	
	</td>
	<td bgcolor="white" width="45%">
		<center><h4>${key.r_title}</h4></center>
	</td>
	<td bgcolor="white">
		<p>
